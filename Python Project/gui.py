...
if __name__=="__main__":
    ...
    label_d=Label(root,text="Year :",font=("Arial",10),width=10)
    ...
    bb=Entry(root,textvariable=fn,width=10)    
    
    cc=Entry(root,textvariable=ln,width=10)    
    
    dd = ttk.Combobox(root,width=10)    
    dd['values']= ("SELECT",1, 2, 3, 4 )
    dd.current(0) 
    
    ee = ttk.Combobox(root,width=10)    
    ee['values']= ("A","B","C","D","E")
    ee.current(0) 
    
    ff = ttk.Combobox(root,width=10)    
    ff['values']= ("SELECT","Male","Female")
    ff.current(0) 
    
    gg=Entry(root,textvariable=fa_name,width=10)    
    
    hh=Entry(root,textvariable=mo_name,width=10)    
    
    ii=Entry(root,textvariable=mob,width=10)    
    
    jj=Entry(root,textvariable=ad,width=10)    
    ...
    label_d1=Label(root,text="Year :",font=("Arial",10),width=10)
    ...
    roll_roll1=Entry(root,textvariable=roll1,width=10)    
    ...
    bb1=Entry(root,textvariable=fn,width=10)    
    
    cc1=Entry(root,textvariable=ln,width=10)    
    
    dd1 = ttk.Combobox(root,width=10)    
    dd1['values']= ("SELECT",1, 2, 3, 4)
    dd1.current(0) 
    
    ee1 = ttk.Combobox(root,width=10)    
    ee1['values']= ("A","B","C","D","E")
    ee1.current(0) 
    
    ff1 = ttk.Combobox(root,width=10)    
    ff1['values']= ("SELECT","Male","Female")
    ff1.current(0) 
    
    gg1=Entry(root,textvariable=fa_name,width=10)    
    
    hh1=Entry(root,textvariable=mo_name,width=10)    
    
    ii1=Entry(root,textvariable=mob,width=10)    
    
    jj1=Entry(root,textvariable=ad,width=10)    
    ...
    combo_class['values']= ("Course Name","Problem Solving Using Python","Object Oriented Programing in Java","Introduction To Linux","Database Management System","Computer Networks","Programing in C","Advanced Web Technologies")
